const url = 'https://brotherblazzard.github.io/canvas-content/latter-day-prophets.json'; // URL do JSON
...
function displayProphets(prophets) {
    prophets.forEach(prophet => {
        ...
        clone.querySelectorAll("p")[0].textContent = `Data de nascimento: ${prophet.birthdate}`;
        clone.querySelectorAll("p")[1].textContent = `Local de nascimento: ${prophet.birthplace}`;
        clone.querySelector(".profile").src = prophet.imageurl;
        clone.querySelector(".profile").alt = `Retrato de ${prophet.name} ${prophet.lastname}`;
